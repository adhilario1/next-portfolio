    ...
    <div className="page-container">
      ...
      <div className="page-body">
        <div className="formatted-text">
          This website was built not only to serve as a portal to display the thing I have done to date* as an exercise to teach myself about the React framework and TypeScript, 
          and as a working example of the skills I developed from my university education. moving forward, This will also be a repository of all the things I make, not necessarily 
          software related.
          <br />
          <br />
          <hr />
          <br />
          <h2 className='secondary-label'>the nitty gritty</h2>
